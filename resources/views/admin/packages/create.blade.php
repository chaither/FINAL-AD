...
<head>
    ...
    <title>Create Package - Admin Dashboard</title>
    ...
    <header class="sticky top-0 z-40 bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="hidden md:block text-lg font-semibold text-gray-900">Create Package</span>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur ring-1 ring-gray-200 rounded-2xl p-8 hover-lift">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Add a new photobooth service package to your offerings</p>
                    </div>
